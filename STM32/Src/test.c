...
// #define Q_SHIFT            14
// #define ROLL_THRESH        500         // Threshold to start moving
// #define MAX_ROLL_ERROR     3000        // Error at max speed
// #define MIN_PSC            10          // Fastest speed (higher PWM frequency)
// #define MAX_PSC            80          // Slowest speed
// #define DEADBAND          100          // Error range where motor stops
...
//      HAL_GPIO_WritePin(GPIOC, GPIO_PIN_8, GPIO_PIN_SET);   // set MS2
